...
The proposed architecture integrates USB-based OmniAIScopes, a central data hub, and REST/WebSocket communication protocols, 
...
Field tests in 50–60 workshops over a six-month period validated the system's technical feasibility, 
...
% 5. Outlook
\section{Outlook}
Discuss future work, including integration of the aAIScope platform, advanced federated ML modules, and expanded partner networks under GAIA-X.

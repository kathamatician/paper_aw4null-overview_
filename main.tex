...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{obd_device.jpeg}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{scope_old.jpg}
    \caption{Old Oscilloscope}
    \label{fig:oldscope}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{scope_keysight.jpg}
    \caption{Keysight Lab Scope}
    \label{fig:keysightscope}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{scope_autoscope.jpg}
    \caption{FCD Autoscope}
    \label{fig:autoscope}
  \end{subfigure}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{good.jpeg}
    \caption{Good Waveform}
    \label{fig:goodwaveform}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bad.png}
    \caption{Bad Waveform}
    \label{fig:badwaveform}
  \end{subfigure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{data_servebadwaveforme.svg}
...
Tahe described pattern of analysis requires all of the posted data to be already in the RAM of the client’s machine, while the data itself can only be acquired one sample at a time over a certain period. 
